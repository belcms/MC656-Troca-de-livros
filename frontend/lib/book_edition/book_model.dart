...
class Book {
  ...
  // 👇 1. Substituímos o coverUrl por uma lista de URLs
  ...
  factory Book.fromJson(Map<String, dynamic> json) {
    ...
    // 👇 2. Lógica para extrair a lista de fotos com fallback para a foto antiga
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      // 👇 3. Envia os dois formatos para não quebrar APIs antigas
      'photos': photoUrls,
