...
void main() {
  group('Tests for the widgets from feed', () {
    testWidgets('EmptyFeedState should show the icon and text correctly', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: EmptyFeedState())),
      );
    ...
    testWidgets('AnnouncementCard should show title, year and CEP correctly', (
      WidgetTester tester,
    ) async {
